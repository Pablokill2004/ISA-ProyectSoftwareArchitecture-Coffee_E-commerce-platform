...
1. **ADR-001 – Deployment Model (Microkernel en un solo contenedor)**
...
2. **ADR-002 – Communication Style (Sincrónico HTTP + eventos internos)**
...
3. **ADR-003 – Database Strategy (Database-per-context en un solo cluster)**
